...
let TYPESENSE_SERVER_CONFIG = {
  apiKey: process.env.PARCEL_TYPESENSE_SEARCH_ONLY_API_KEY, // Be sure to use an API key that only allows searches, in production
  nodes: [
    {
      host: process.env.PARCEL_TYPESENSE_HOST,
      port: process.env.PARCEL_TYPESENSE_PORT,
      protocol: process.env.PARCEL_TYPESENSE_PROTOCOL,
    },
  ],
  numRetries: 8,
